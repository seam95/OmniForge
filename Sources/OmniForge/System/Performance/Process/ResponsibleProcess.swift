...
/// a human name. Shared by process breakdown rows so helpers roll up under
/// their owning app with its proper name/icon.
enum ResponsibleProcess {
    ...
    /// kernel-reported name, then to the caller's hint.
